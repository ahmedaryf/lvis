...
//                     height={800}
//                     alt={item.title}
//                     className='aspect-[16/9] object-cover w-full h-[70vh] md:h-auto zoom-slow'
//                   />
//                 )}
//               </SwiperSlide>
//             ))}
...
//         <h1 className='text-center text-zinc-300 dark:text-zinc-400 font-bold custom-font text-5xl my-4 md:my-8 uppercase tracking-wide md:hidden pb-6'>
//           keyodhoo school
//         </h1>
