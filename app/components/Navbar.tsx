            ...
            <div className=''>
              <Link href={"/"}>
                <Image
                  ...
                  width={60}
                  height={60}
                  className='w-[50px] md:w-[60px]  object-cover'
                />
              </Link>
            </div>
            {/* Desktop */}
                ...
                {navLinks.map((navItem, index) => (
                  <div
                    ...
                    {/* Parent Link */}
                    {
                      <Link
                        href={navItem.url}
                        className={`inline-block border-b body-font ${
                          navItem.url === path
                            ? `border-b  ${scrollPosition < 200 ? "boder-white group-hover:border-zinc-400 " : "border-zinc-400"}`
                            : "border-transparent"
