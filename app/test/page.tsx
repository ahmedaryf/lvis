...
export default function Page() {
  ...
  useEffect(() => {
    ...
    tl.to(circleRef.current, { morphSVG: "#hippo" }, "+=1")
      .to(circleRef.current, { morphSVG: "#star" }, "+=1")
      .to(circleRef.current, { morphSVG: "#elephant" }, "+=1")
      .to(circleRef.current, { morphSVG: circleRef.current }, "+=1");
  ...
  return (
    <div className='  min-h-screen'>
      <div className='p-8'>
        {/* SVG section */}
        <svg viewBox='0 0 800 400' width='100%' height='400' className='ssvig'>
          <path
            id='circle'
            ref={circleRef}
            d='M300,200a100,100 0 1,0 200,0a100,100 0 1,0 -200,0'
            fill='purple'
          />
          <path
            id='hippo'
            className='st1'
            d='M148.802,244.876c2.737-36.735,16.107-69.079,40.099-97.061
	...
	l-53.666,28.214l10.249-59.758l-43.417-42.321l60-8.719L409.6,198.066z'
      ...
      <h1>Test Page</h1>
      {/* <div className='p-24 bg-black/60 '>
        <div className='svg-mask'></div>
        <div className='[clip-path:circle(25%_at_50%_50%)] w-64 h-64 bg-amber-300 '></div>
        <div className='w-64 h-64 bg-orange-600 [clip-path:polygon(30%_30%,70%_30%,70%_60%,30%_70%)]'></div>
        <svg width='400' height='400'>
          ...
          <rect width='100%' height='100%' fill='green' mask='url(#mm)' />
        </svg>
        <div className='masked-element w-64 h-64 bg-amber-400'>
          <h5>
        ...
        <div>
          ...
          <svg width='0' height='0'>
            <defs>
              <clipPath id='circle-hole' clipPathUnits='objectBoundingBox'>
                <path
                  d='
                M0,0 h1 v1 h-1 z
                M0.5,0.25
                a0.25,0.25 0 1,0 0.001,0
                z
              '
                  fillRule='evenodd'
                />
          ...
          <div
            className='element w-64 h-64 bg-pink-500'
            style={{ clipPath: "url(#circle-hole)" }}></div>
        </div>
      </div> */}
      <div>
        <div id='slider'></div>
